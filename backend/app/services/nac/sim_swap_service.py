...
class SimSwapService:
    def __init__(self) -> None:
        ...
        self.api_path = "/passthrough/camara/v1/sim-swap/sim-swap/v0"
        self.headers = {
    ...
    def _make_request(
        ...
        try:
            ...
            raise UpstreamServiceError(f"SIM Swap API error: {exc}") from exc
        except Exception as exc:
            raise UpstreamServiceError(f"SIM Swap service error: {exc}") from exc
